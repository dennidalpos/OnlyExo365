...
- Verified in this repository context on 2026-04-17: `doctor.ps1`, `doctor.ps1 -CheckPackaging`, locked restore through `bootstrap.ps1`, Debug compile for `win-x64`, and the automated test suite.
- Automated tests passed locally with 708 tests.
