...
namespace ExchangeAdmin.Application.Security;
...
public static class LeastPrivilegeCatalog
{
    ...
    [
        ...
        new LeastPrivilegeFeatureDefinition
        {
            ...
            Notes = "License write scopes are opt-in via graphLicenseWriteScopes / EXCHANGEADMIN_GRAPH_LICENSE_WRITE_SCOPES. AppCertificate mode also requires GraphTenantId to avoid implicit tenant discovery."
        }
    ];
