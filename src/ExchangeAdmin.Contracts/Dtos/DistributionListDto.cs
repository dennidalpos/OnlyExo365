...
public abstract class GroupIdentityDto
{
...
public class DistributionListItemDto : GroupIdentityDto
{
...
public class DistributionListDetailsDto : GroupIdentityDto
{
    [JsonPropertyName("groupType")]
    public string GroupType { get; set; } = string.Empty;
    ...
    public GroupMembersPageDto? Owners { get; set; }
}

public class DynamicDistributionListDetailsDto : GroupIdentityDto
{
...
public class UnifiedGroupDetailsDto : GroupIdentityDto
{
    [JsonPropertyName("accessType")]
    public string? AccessType { get; set; }
...
public class GetDistributionListsRequest
{
    ...
    [JsonPropertyName("groupTypeFilter")]
...
public class GetDistributionListDetailsRequest
{
    ...
    [JsonPropertyName("groupTypeHint")]
    public string? GroupTypeHint { get; set; }

    [JsonPropertyName("includeMembers")]
    public bool IncludeMembers { get; set; } = true;

    [JsonPropertyName("membersPageSize")]
    public int MembersPageSize { get; set; } = PagingDefaults.DefaultPageSize;
}
...
public class PreviewDynamicGroupMembersRequest
{
    ...
    public int MaxResults { get; set; } = PagingDefaults.DefaultPageSize;
}
