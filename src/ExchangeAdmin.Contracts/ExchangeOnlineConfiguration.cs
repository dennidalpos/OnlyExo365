...
{
    public const string ExchangeEnvironmentName = "EXCHANGEADMIN_EXO_ENV";
    public const string AuthenticationMode = "EXCHANGEADMIN_AUTH_MODE";
    public const string ExchangeOrganization = "EXCHANGEADMIN_EXO_ORGANIZATION";
    public const string DelegatedOrganization = "EXCHANGEADMIN_EXO_DELEGATED_ORGANIZATION";
    public const string UserPrincipalNameHint = "EXCHANGEADMIN_EXO_UPN_HINT";
    public const string ApplicationId = "EXCHANGEADMIN_APP_ID";
    public const string CertificateThumbprint = "EXCHANGEADMIN_CERT_THUMBPRINT";
    public const string CertificateSubjectName = "EXCHANGEADMIN_CERT_SUBJECT";
    public const string ManagedIdentityAccountId = "EXCHANGEADMIN_MANAGED_IDENTITY_ACCOUNT_ID";
    public const string GraphTenantId = "EXCHANGEADMIN_GRAPH_TENANT_ID";
    public const string GraphScopes = "EXCHANGEADMIN_GRAPH_SCOPES";
    public const string GraphLicenseWriteScopes = "EXCHANGEADMIN_GRAPH_LICENSE_WRITE_SCOPES";
    public const string DefaultUsageLocation = "EXCHANGEADMIN_DEFAULT_USAGE_LOCATION";
    public const string EnableGraphAfterExchangeConnect = "EXCHANGEADMIN_ENABLE_GRAPH";
}
