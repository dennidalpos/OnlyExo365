...
public sealed class ShellViewModel : ViewModelBase, IDisposable
{
    ...
    /// </summary>
    public event EventHandler<ExchangeAdmin.Presentation.Services.CatalogUpdatedEventArgs>? LicenseCatalogUpdated;

    internal void RaiseLicenseCatalogUpdated(ExchangeAdmin.Presentation.Services.CatalogUpdatedEventArgs args)
