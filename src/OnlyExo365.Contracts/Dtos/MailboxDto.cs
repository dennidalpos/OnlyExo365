...
public class MailboxFolderPermissionEntryDto
{
...
public class GetMailboxFolderPermissionsRequest
{
    [JsonPropertyName("mailboxIdentity")]
    public string MailboxIdentity { get; set; } = string.Empty;

    [JsonPropertyName("folderPath")]
    public string FolderPath { get; set; } = "Calendar";
}

public class GetMailboxFolderPermissionsResponse
{
    [JsonPropertyName("mailboxIdentity")]
    public string MailboxIdentity { get; set; } = string.Empty;
    ...
    [JsonPropertyName("resolvedFolderIdentity")]
    public string ResolvedFolderIdentity { get; set; } = string.Empty;

    [JsonPropertyName("permissions")]
    public List<MailboxFolderPermissionEntryDto> Permissions { get; set; } = new();
}
...
public class GetMailboxSpaceReportResponse
{
    ...
    [JsonPropertyName("processedMailboxCount")]
    public int ProcessedMailboxCount { get; set; }

    [JsonPropertyName("failedMailboxCount")]
    public int FailedMailboxCount { get; set; }
}

public class GetMailboxAccessReportRequest
{
}

public class GetMailboxAccessReportResponse
{
    [JsonPropertyName("correlationId")]
    public string? CorrelationId { get; set; }

    [JsonPropertyName("grants")]
    public List<MailboxAccessGrantDto> Grants { get; set; } = new();
...
public class MailboxAccessGrantDto
{
    [JsonPropertyName("user")]
    public string User { get; set; } = string.Empty;
    ...
    [JsonPropertyName("mailboxPrimarySmtpAddress")]
    public string MailboxPrimarySmtpAddress { get; set; } = string.Empty;
...
public class SetMailboxFolderPermissionRequest
{
    [JsonPropertyName("mailboxIdentity")]
    public string MailboxIdentity { get; set; } = string.Empty;
