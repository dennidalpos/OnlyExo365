...
{
    public const string SessionTokenEnvironmentVariable = "ONLYEXO365_IPC_SESSION_TOKEN";
    ...
    public const string PipeName = "OnlyExo365_IPC_Main";

                 
                                                                        
                  
    public const string EventPipeName = "OnlyExo365_IPC_Events";
    ...
    public const int RequestTimeoutMs = 900000;            
