...
public sealed class MailboxLicensesViewModel : ViewModelBase
{
    ...
    private static string BuildLicenseWriteDisabledMessage(LeastPrivilegeFeatureEvaluation evaluation)
    {
        ...
        var baseMessage =
            $"License changes are disabled by the current configuration. Add {scopeName} to graphLicenseWriteScopes or ONLYEXO365_GRAPH_LICENSE_WRITE_SCOPES and reconnect the session.";
