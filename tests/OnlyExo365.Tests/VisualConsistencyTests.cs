...
public sealed class VisualConsistencyTests
{
    ...
    public void DistributionListView_UsesSharedActionStylesAndLocalizedLabels()
    {
        ...
        var content = File.ReadAllText(TestPathHelper.GetRepositoryPath("src", "OnlyExo365.Shell", "Views", "DistributionListView.xaml"));
    ...
    public void PermissionsView_UsesSharedActionStylesAndThemeBackgrounds()
    {
        ...
        var content = File.ReadAllText(TestPathHelper.GetRepositoryPath("src", "OnlyExo365.Shell", "Views", "PermissionsView.xaml"));
    ...
    {
        var content = File.ReadAllText(TestPathHelper.GetRepositoryPath("src", "OnlyExo365.Shell", "Views", fileName));
    ...
    private static XDocument LoadTheme(string fileName)
        => XDocument.Load(TestPathHelper.GetRepositoryPath("src", "OnlyExo365.Shell", "Themes", fileName));

    private static XDocument LoadView(string fileName)
        => XDocument.Load(TestPathHelper.GetRepositoryPath("src", "OnlyExo365.Shell", "Views", fileName));
}
